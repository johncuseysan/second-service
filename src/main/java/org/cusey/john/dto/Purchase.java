...
public class Purchase {
	...
	public String collegeNumber;				//5 Length 17 Allowed values: 0-9
	...
	public String toString() {
		return "Purchase [cost=" + cost + ", period=" + period + ", transactionDate=" + transactionDate + ", startDate="
				...
				+ collegeName + ", collegeCatolog=" + collegeCatolog + ", collegeNumber=" + collegeNumber
				+ ", collegeType=" + collegeType + ", method=" + method + ", isAction=" + isAction + "]";
	}
